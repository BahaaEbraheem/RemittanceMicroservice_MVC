...
public class RemittanceManagementWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public RemittanceManagementWebHostMenuContributor(IConfiguration configuration)
    {
